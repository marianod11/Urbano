  ...
  if (!isLoading) {
    return (
      <div className="card shadow">
        ...
        >
          <h1 className="font-roboto text-4xl mb-10 ">{`Welcome ${data.firstName}`}</h1>
          <hr />
          <div className="flex gap-3 w-full">
            <div className="w-1/2">
              <label className="font-roboto">First Name</label>
              <input
                type="text"
            ...
            <div className="w-1/2">
              <label className="font-roboto">Last Name</label>
              <input
                type="text"
                className="input w-full mt-1"
          ...
          <div className="w-full">
            <label className="font-roboto">Username</label>
            <input
              type="text"
              className="input w-full mt-1"
          ...
          <button
            className="btn w-full bg-brand-primary"
            disabled={isSubmitting}
          >
            {isSubmitting ? (
          ...
          {error ? (
            <div className="text-red-500 p-3 font-roboto border rounded-md bg-red-50">
              {error}
            </div>
          ) : null}
        </form>
